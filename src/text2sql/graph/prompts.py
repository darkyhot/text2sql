...
PLAN_SYS = (
    ...
    "- Для подсчёта количества уникальных сущностей (сколько ГОСБ/клиентов/...) бери "
    "идентификатор АКТУАЛЬНЫЙ и наиболее уникальный (большой уник%, напр. 'новый номер'), "
    "а НЕ исторический/старый, даже если старый помечен PK — старый может повторяться и недосчитает.\n"
